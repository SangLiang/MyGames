...
function Qp_g() {
	...
	a.graphics.lf(["#d2ae6c", "#efd68d"], [0, 1], 0, 0, 0, H).r(0, 0, W, H);
	this.addChild(a);
...
Qp_h.prototype.startGame = function () {
	...
	if (!1 == qp_e) {
		...
		qp_e = !1;
		var a = new createjs.Text("绿线下点水果托飞它", "bold 60px Arial", "#005933");
		a.stroke = "white";
...
function Qp_p() {
	...
	this.scoreText = new createjs.Text(score, "bold 60px Arial", "#e50000");
	this.scoreText.stroke = "white";
	this.scoreText.textBaseline = "middle";
	this.scoreText.x = 420;
	this.scoreText.y = 330;
	this.addChild(this.scoreText);
	this.bestscoreText = new createjs.Text(best, "bold 60px Arial", "#e50000");
...
function Qp_l() {
	...
	this.logopicture.y = 270;
	this.addChild(this.logopicture);
	this.start = new Qp_n("btnframe", "startbtnlabel", qp_i, 325, 520);
	...
	this.top = new Qp_n("btnframe", "topbtnlabel", qp_j, 160, 750);
...
function Qp_m() {
	...
	a.y = 50;
	this.addChild(a);
	this.scoreText = new createjs.Text("0", "bold 48px Arial", "#ffffff");
	this.scoreText.stroke = "white";
	this.scoreText.textBaseline = "middle";
